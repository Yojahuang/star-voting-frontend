...
<template>
    <div v-if="!smAndDown" id="my-page" class="mx-auto w-75">
    ...
    <div v-else id="my-page" class="mx-auto w-75">
        <div class="text-h4 my-6 font-weight-bold">What we offer</div>

        <div class="mx-auto w-100">
            <div v-for="(card, idx) in cards" :cols="card.flex" class="mx-auto">
                <v-expand-transition>
                    <v-card @click="flipcard(idx)" v-show="card.show" class="mx-auto my-4" elevation="21" width="300"
                        height="300" variant="tonal">
                        <template v-if="card.showText">
                            <div class="mx-auto w-75 h-100 d-flex align-center font-center">
                                {{ card.text }}
